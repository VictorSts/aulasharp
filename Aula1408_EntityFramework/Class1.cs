...
namespace Aula1408_EntityFramework
{
    /** Conceitos
        ...
        É um framework objeto-relacional que permite o que o .NET consiga trabalhar com o banco de dados relacional usando seus objetos. Eliminado o tempo que os programadores perdiam montando as querys.

        3-Para que serve a classe contexto?
        Geralmente representa uma conexão de banco de dados e um conjunto de tabelas. 
        Contexto contém os métodos e propriedades para comunicação do banco de dados.
